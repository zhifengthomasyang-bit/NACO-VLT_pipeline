# -*- coding: utf-8 -*-
"""
Created on Tue Jun  2 10:57:58 2026
...
path = r"D:\headers\alignment\calib 2005-05-08 Imaging Ceres8_K expt-1.0 OP3 FULL OP6 H HD DR S13\2005-05-09T02_36_40.993 - 2005-05-09T02_39_43.758"
variables.update(csv_to_dict(os.path.join(path, "Ephemcc 2005-05-09T02_37_27.443.csv")))
variables.update(csv_to_dict(os.path.join(path, "Ephemph 2005-05-09T02_37_27.443.csv")))
fits_path = os.path.join(path, "2005-05-09T02_36_40.993 - 2005-05-09T02_39_43.758.fits")
...
plt.savefig(os.path.join(path, "orthographic projection.png"))
plt.show()
...
plt.savefig(os.path.join(path, "Unwrapped_Map_2-98.png"))
plt.show()
...
plt.savefig(os.path.join(path, f"emission {angle}.png"))
plt.show()
...
plt.savefig(os.path.join(path, f"incidence {angle}.png"))
plt.show()
