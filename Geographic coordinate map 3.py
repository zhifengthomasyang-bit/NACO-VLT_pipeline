# -*- coding: utf-8 -*-
"""
Created on Tue Jun 30 16:01:00 2026
...
path = r"D:\headers\alignment\calib 2005-05-09 Imaging Ceres9_L expt-2.0 OP3 FULL OP6 Ks HD DR S13\2005-05-10T01_18_33.644 - 2005-05-10T01_23_16.090"
variables.update(csv_to_dict(os.path.join(path, "Ephemph 2005-05-10T01_20_29.280.csv")))
variables.update(csv_to_dict(os.path.join(path, "Ephemcc 2005-05-10T01_20_29.280.csv")))
fits_path = os.path.join(path, "2005-05-10T01_18_33.644 - 2005-05-10T01_23_16.090.fits")

path2 = r"D:\headers\alignment\calib 2005-05-09 Imaging Ceres9_L expt-2.0 OP3 FULL OP6 Ks HD DR S13\2005-05-10T01_18_33.644 - 2005-05-10T01_23_16.090\photometry"
...
print("Longitude range:", lon_min, lon_max - 360 if lon_max > 360 else lon_max)
...
plt.title(f"Ceres Map (emission angle < Approximately {angle}°)")
plt.colorbar(label="Intensity (ADU)")
plt.legend()

plt.savefig(os.path.join(path2, f"emission Approximately {angle}.png"))
plt.show()
...
img_lambert = np.full_like(
    img_masked,
    np.nan
)

img_lambert[lambert_mask] = (
    img_masked[lambert_mask] /
    cos_i[lambert_mask]
)

save_path = os.path.join(path2, "Ceres_map_data.npz")
